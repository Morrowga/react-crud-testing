...
export default function ResponseDialog({isOrderOpen,openOrder,setCheckoutSuccess, checkoutSuccess}) {
  ...
  const closePopUpAndGoToOrder = () => {
    setCheckoutSuccess(false)
    openOrder()
  }
  return (
    <Transition.Root show={checkoutSuccess} as={Fragment}>
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  {!isOrderOpen && <button
                    ...
                    onClick={() => closePopUpAndGoToOrder()}
                  >
                    Check your orders
                  </button>}
                  <button
